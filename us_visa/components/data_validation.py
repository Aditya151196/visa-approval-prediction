...
class DataValidation:
    def __init__(self,data_ingestion_artifact:DataIngestionArtifact,data_validation_config:DataValidationConfig):
        """
        params:
            data_ingestion artifact : output reference of data ingestion stage(data ingestion artifact)
            data validation config : configuration of data validation
        """
    ...
    def detect_dataset_drift(self,reference_df: DataFrame, current_df:DataFrame)->bool:
        """
        Method Name : detect dataset drift
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        """ 
        Method Name : initiate data validation
        ...
        try:
            ...
            if not status:
                validation_err_msg+=f"Columns are missing in testing dataframe"
